...
export const ROLE_META: Record<string, RoleMeta> = {
  ...
  streamer: { label: "Streamer", chip: "bg-violet-400/15 text-violet-200 ring-violet-400/30" },
...
export const ROLE_ORDER = ["admin", "bidder", "streamer", "wotblitz", "guest", "excluded"];
...
const ROLE_PRECEDENCE = ["excluded", "admin", "bidder", "streamer", "wotblitz", "guest"];
