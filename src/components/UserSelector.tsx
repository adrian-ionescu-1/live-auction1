...
export default function UserSelector() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-2xl rounded-3xl bg-black/35 ring-1 ring-white/10 backdrop-blur-sm p-8">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-zinc-100 mb-2 text-center">
          Live Auction System
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {users.map((user) => (
            <button
              ...
              className={`group p-6 rounded-3xl ring-1 transition active:scale-[0.98]
                ${
                  user.role === 'ADMIN'
